...
HLS_PROXY_PREFIX = os.environ["HLS_PROXY_PREFIX"].strip("/") + "/"
HLS_PROXY_FETCH_TIMEOUT_SECONDS = int(os.environ["HLS_PROXY_FETCH_TIMEOUT_SECONDS"])
HLS_PROXY_PLAYLIST_MAX_BYTES = int(os.environ["HLS_PROXY_PLAYLIST_MAX_BYTES"])
HLS_PROXY_SEGMENT_MAX_BYTES = int(os.environ["HLS_PROXY_SEGMENT_MAX_BYTES"])
